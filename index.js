...
async function fetchLegendaryCards() {
    ...
    try {
        do {
            ...
            const capitalizedCards = filteredCards.map(card => {
                const capitalizedRarity = card.rarity 
                    ? card.rarity.charAt(0).toUpperCase() + card.rarity.slice(1) 
                    : 'Unknown'; // Use 'Unknown' or any default value if rarity is not set
            ...
            legendaryCards.push(...capitalizedCards); // Add capitalized cards
